...
int check_error(char *command, int *line, int *nb_matches, char **tab);
void clean_buffer(char **tab, int line, int nb_matches);
void my_n_strcat(char c, int n, char *buffer);
int my_pos(char *str);
